...
const AWSClientService = () => {
    ...
    const functionToDict = {
        ...
        "Stop a given instance": stopEBSInst,
        "Terminate a given instance": terminateEBSInst,
        ...
        "Create snapshot of an instance": createSnapshot,
        "Remove all ingress and egress routes to given instance": quarantineEc2,
    };
